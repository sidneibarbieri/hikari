...
steps=(
  ...
  "tests/verify_team_flow.sh|team competitors: captain creates team, member request is approved by captain"
  "tests/verify_challenge_library.sh|admin imports a validated portable challenge library"
